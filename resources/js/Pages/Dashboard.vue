        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="w-1/2 ">
                        <div class="align-center text-center rounded-lg p-3 bg-indigo-900">
                            ...
                            <div class="text-center justify-center">
                                ...
                                <div class="font-semibold mb-3 text-gray-200">Overdue deadlines in:</div>
                                <div v-for="late in lateScrumboard" :key="late.id" class="mb-3 text-gray-200">
                                    <a :href="route('getCards', { scrumId: late.id })" class="rounded-lg p-3 hover:bg-indigo-800">
                                        {{ late.name }}
                                    </a>
                                </div>
                            </div>
